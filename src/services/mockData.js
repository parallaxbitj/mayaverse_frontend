...
export const mockEvents = [
  ...
  {
    id: '7',
    title: 'Techno Quiz / Programmix Event',
  ...
  },
  {
    ...
    status: EVENT_STATUS.UPCOMING,
    date: '2026-03-12',
    time: '3:00 PM - 4:30 PM', // Assuming closing time based on next event
    venue: 'SEMINAR',
    registrationFee: 0,
    maxParticipants: 100,
    currentParticipants: 0,
  ...
  {
    id: '25',
    title: 'RELAY CODING (programmix)',
    description: 'A relay-style competitive programming event where team members take turns to solve algorithmic challenges.',
    category: EVENT_CATEGORIES.TECHNICAL,
    status: EVENT_STATUS.UPCOMING,
    date: '2026-03-11',
